...
public class SnowWaifuRenderer extends HumanoidMobRenderer<SnowWaifuEntity, SnowWaifuModel> {

    private static final ResourceLocation textureLoc = TwilightForestMod.getModelTexture("snowqueen.png");

    public SnowWaifuRenderer(EntityRendererProvider.Context manager, SnowWaifuModel model) {
